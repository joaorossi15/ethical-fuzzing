...
def reid_output_row(result, variant):
    ...
    return [
        ...
        variant.get("variant_id"),
        meta.get("case_id"),
        meta.get("target_identity"),
        meta.get("protected_candidates"),
        meta.get("boundary_strength"),
        meta.get("deidentification_level"),
        meta.get("overlap_level"),
        meta.get("metamorphic_relation"),
        meta.get("probe_style"),
        meta.get("deidentified_candidates"),
        meta.get("deidentified_candidates_after_transformation"),
        variant.get("messages"),
        result.get("text"),
        "-",
        "0",
